...
class App(customtkinter.CTk):
    ...
    def btn_convertir_c_f_on_click(self):
        ...
        temperatura_c_float = float(temperatura_c_str) 
        
        result = (temperatura_c_float * 1.8) + 32
        alert("Calculadora",f"La temperatura en celsicius es: {result}")
        
        temperatura_f_str = self.txt_temperatura_f.get()
        
        temperatura_f_float = float(temperatura_f_str) 
        
        result = (temperatura_f_float - 32) * 5/9
        alert("Calculadora",f"La temperatura en farenheit es: {result}")
